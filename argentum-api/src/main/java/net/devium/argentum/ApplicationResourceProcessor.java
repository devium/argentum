...
public class ApplicationResourceProcessor implements ResourceProcessor<RepositoryLinksResource> {
    ...
    public RepositoryLinksResource process(RepositoryLinksResource resource) {
        ...
        resource.add(ControllerLinkBuilder.linkTo(CoatCheckTagController.class).withRel("coat_check"));
        ...
        resource.add(ControllerLinkBuilder.linkTo(ConfigController.class).withRel("config"));
        resource.add(ControllerLinkBuilder.linkTo(CategoryController.class).withRel("statuses"));
        return resource;
    }
}
